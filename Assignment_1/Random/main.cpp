...
int main() {
    ...
    for (const auto& instance : instances) {
        results_file << "Instance Name,Repetitions,Iterations,Optimal Cost,Optimal Path\n";
        results_file << instance.getFilename() << "," << instance.getRepetitions() << "," << instance.getRandomIterations() << "," << instance.getOptimalCost() << ",";
        ...
        for (int rep = 0; rep < instance.getRepetitions(); rep++) {
            ...
            result = TSP_Random::TSP_Random_start(instance.getVertices(), instance.getAdjacencyMatrix(), instance.getRandomIterations());
